...
public class CampPageDTO {
	...
	public CampPageDTO(int page, int rowsize, int totalRecord) {
		this.page = page;
	...
	public CampPageDTO(int page, int rowsize, int totalRecord, String search, String keyword) {
